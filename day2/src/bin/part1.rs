fn main() {
    ...
    loop {
        ...
        match cmd {
            99 => break,
            1 => i[i[pos+3]] = i[i[pos + 1]] + i[i[pos + 2]],
            2 => i[i[pos+3]] = i[i[pos + 1]] * i[i[pos + 2]],
            _ => {} //panic!
        }
        pos += 4;
    }
